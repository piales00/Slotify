...
public class DatosIniciales {
  ...
  public static void cargarProductos(Catalogo catalogo) {
    ...
    catalogo
        .agregarProducto(new Producto("Tornillos M8 (caja)", "SKU-003", "Ferretería", 0.01, 2.0, 200, "A", "Manual"));
    ...
    catalogo
        .agregarProducto(new Producto("Bomba hidráulica", "SKU-006", "Hidráulica", 0.25, 48.0, 8, "C", "Montacargas"));
    catalogo
        .agregarProducto(new Producto("Bobina de cable", "SKU-007", "Eléctrico", 0.10, 25.0, 30, "B", "Montacargas"));
    catalogo
        .agregarProducto(new Producto("Aceite de motor 5L", "SKU-008", "Lubricantes", 0.006, 4.5, 150, "A", "Manual"));
